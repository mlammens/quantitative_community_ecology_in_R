...
* Read in a dataset and perform basic data summary procedures in R
...
One of the most basic things you will need to do in R is read in your own dataset. 
...
Let's read in a dataset of trait measurements from 56 different plant species using the function `read.csv`.
First, you'll need to download the dataset from the workshop site. 
...
Next we'll use the `summary` function to examine this dataset.
...
These analyses require complete datasets, and will not work if there are missing values. 
...
Let's make a histogram of minimum heights in the trait dataset.
