...
While we went over how to read in data via a \*.csv file in \@ref(intro-to-RStudo), we will take advantage of the fact that our example data sets have already been read in to R and saved as a \*.rda object.
...
Use the R functions and techniques covered in \@ref(intro-to-RStudio) to explore and examine the various data sets in the `veg` object. What information do you think each data table contains?
